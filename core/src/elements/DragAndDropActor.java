...
public class DragAndDropActor extends BaseActor {
    ...
    public DragAndDropActor(float x, float y, Stage s) {
        ...
        addListener(new InputListener() {
            public boolean touchDown(InputEvent event, float eventOffsetX, float eventOffsetY, int pointer,
                                     int button) {
                if (!self.isDraggable())
                    return false;
    ...
    /**
     * If this actor is dropped on a "targetable" actor, that actor can be obtained
     * from this method.
     */
